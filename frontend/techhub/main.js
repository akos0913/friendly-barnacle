// TechHub Frontend JavaScript
class TechHubApp {
    constructor() {
        this.apiBase = 'http://localhost:5000/api/store/tech';
        this.cart = [];
        this.products = [];
        this.init();
    }
    ...
    displayCartItems(data) {
        ...
        container.innerHTML = `
            <div style="margin-bottom: 20px;">
                ${data.items.map(item => `
                    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid var(--border-color);">
                        <div>
                            <div style="font-weight: 600;">${this.escapeHtml(item.product_name || 'Product')}</div>
            ...
            <button style="width: 100%; padding: 12px; background: var(--success-color); color: white; border: none; border-radius: 6px; font-weight: 600; cursor: pointer;" onclick="app.checkout()">
                Checkout
            </button>
        `;
    }
